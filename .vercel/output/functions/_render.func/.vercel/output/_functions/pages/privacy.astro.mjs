...
}, "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/components/infopages/Privacy.astro", void 0);

const $$Privacy = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "PrivacyForm", $$Privacy$1, {})} ` })}`;
}, "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/pages/privacy.astro", void 0);

const $$file = "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/pages/privacy.astro";
const $$url = "/privacy";
