...
}, "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/components/infopages/Terms.astro", void 0);

const $$Terms = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TermsForm", $$Terms$1, {})} ` })}`;
}, "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/pages/terms.astro", void 0);

const $$file = "D:/mundo-vinilos/mundo-vinilos/absolute-antimatter/src/pages/terms.astro";
const $$url = "/terms";
